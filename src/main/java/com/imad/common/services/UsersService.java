...
public class UsersService {
	...
	public EntrepriseUser getUserById(Integer id){
		...
		Query query = session.getNamedQuery("EntrepriseUsers.findByUserId").setParameter("userId", id);
	...
	public EntrepriseUser getUserByUsername(String username){
		...
		Query query = session.getNamedQuery("EntrepriseUsers.findByUsername").setParameter("username", username);
		return (EntrepriseUser) query.list().get(0);
	}
